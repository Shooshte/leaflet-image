        ...
        function(require, module, exports) {
          ...
          module.exports = function leafletImage(map, callback) {
            ...
            if (map._panes && map._panes.overlayPane.childNodes) {
              for (
                var i = 0;
                i < map._panes.overlayPane.childNodes.length;
                i++
              ) {
                layerQueue.defer(
                  handlePathRoot,
            ...
            if (map._pathRoot) {
              ...
              var firstCanvas = map._panes.overlayPane
            ...
            function handleMarkerLayer(marker, callback) {
              var canvas = document.createElement("canvas"),
                ...
                url = isBase64
                  ? marker._icon.src
                  : addCacheString(marker._icon.src),
                im = new Image(),
            ...
            function addCacheString(url) {
              ...
              if (
                isDataURL(url) ||
                url.indexOf("mapbox.com/styles/v1") !== -1
              ) {
                return url;
              }
              return (
                url + (url.match(/\?/) ? "&" : "?") + "cache=" + cacheBusterDate
              );
            }
